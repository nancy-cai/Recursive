	    	    ...
	    	    if(rcrscUI.isDisplayed()){
	    	    	  ...
	    	    	  WebElement stopRec = driver.findElement(By.linkText("Stop"));   	    	   
	      	    	   ...
	      	    	   if(driver.findElement(By.xpath("//input[contains(@class, 'summary-input form-control input-sm')]")).isDisplayed()){
	      	    		 ...
	      	    		 driver.findElement(By.xpath("//input[contains(@class, 'summary-input form-control input-sm')]")).sendKeys("Replay-Zendesk UI");
	      	    		Thread.sleep(3000); 
	      	    	   }
	      	    	 driver.findElement(By.xpath("//input[contains(@class, 'name-input form-control input-sm')]")).sendKeys("Adactin");
	      	    	 driver.findElement(By.xpath("//input[contains(@class, 'email-input form-control input-sm')]")).sendKeys("chintan.patel@adactin.com");
	      	    	 ...
	      	    	 if(driver.findElement(By.cssSelector("body > div > a.btn.btn-success.btn-xs.sharing-button")).isDisplayed() ){
	      	    		 ...
	      	    		 if(driver.findElement(By.cssSelector("body > div > a.btn.btn-success.btn-xs.sharing-button")).isEnabled()){
